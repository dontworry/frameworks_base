...
public class LockPatternKeyguardView extends KeyguardViewBase {
    ...
    View createLockScreen() {
        int lockScreen = Settings.System.getInt(mContext.getContentResolver(),
                Settings.System.LOCKSCREEN_TYPE_KEY, 1);

		if(lockScreen == 2)
            return new TabLockScreen(mContext, mConfiguration, mLockPatternUtils, mUpdateMonitor,
                    mKeyguardScreenCallback);
		else if(lockScreen == 3)
            return new Tab4LockScreen(mContext, mConfiguration, mLockPatternUtils, mUpdateMonitor,
                    mKeyguardScreenCallback);
