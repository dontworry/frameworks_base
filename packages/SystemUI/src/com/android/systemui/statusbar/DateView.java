...
public final class DateView extends TextView {
    ...
    private final void updateClock() {
       ...
       mDateClockColor = Settings.System.getInt(resolver, Settings.System.DATECLOCK_COLOR, -1);

		setTextColor(mDateClockColor);
      

      if(mStatusbarClock == 3){
        setText("");
      } else if (mStatusbarClock == 1) {
